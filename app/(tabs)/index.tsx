...
export default function Home() {
  ...
  const handleMarkUsed = (productId) => {
    Alert.alert("Mark as Used", "This will archive the product. Continue?", [
            ...
            <View style={styles.dateSection}>
              <View style={styles.dateInput}>
                ...
                >
                  ...
                  <Text style={[styles.dateButtonText, { color: colors.text }]}>{editedProduct.openDate}</Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.dateInput}>
                ...
                >
                  <Calendar size={16} color={colors.primary} />
                  <Text style={[styles.dateButtonText, { color: colors.text }]}>{editedProduct.expiryDate}</Text>
                </TouchableOpacity>
              </View>
            </View>
          </ScrollView>
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.tabContainer}>
        {tabs.map((tab, index) => (
          <TouchableOpacity
            key={index}
            style={[styles.tab, activeTab === index && [styles.activeTab, { backgroundColor: colors.primary }]]}
