...
export default function EditMedicine() {
  ...
  const [medicineName, setMedicineName] = useState('Vitamin D3');
  const [dosage, setDosage] = useState('1000 IU');
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Edit Medicine</Text>
        <TouchableOpacity 
